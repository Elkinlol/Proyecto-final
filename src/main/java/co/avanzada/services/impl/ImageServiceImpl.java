...
public class ImageServiceImpl implements ImageService {
    ...
    public ImageServiceImpl(){
        ...
        config.put("cloud_name", "dlsr4hzzo");
        config.put("api_key", "398141721654857");
        config.put("api_secret", "hvUsWUREkuhq2XA2L8Xpe5WMa9s");
    ...
    public Map upload(MultipartFile image) throws Exception {
        ...
        return cloudinary.uploader().upload(file, ObjectUtils.asMap("folder", "Proyecto-final"));
    }
